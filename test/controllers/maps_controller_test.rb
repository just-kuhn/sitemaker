...
class MapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post maps_url, params: { map: { element_id: @map.element_id, site_id: @map.site_id, value: @map.value } }
    end
  ...
  test "should update map" do
    patch map_url(@map), params: { map: { element_id: @map.element_id, site_id: @map.site_id, value: @map.value } }
